...
+ Steg 1: Ställ in datastruktur och importera exempeldata {#set-up-data-structure-and-ingest-data}
   + [Ställ in datastrukturen och importera exempeldata med Postman](https://experienceleague.adobe.com/docs/platform-learn/tutorials/import-sample-data.html)
