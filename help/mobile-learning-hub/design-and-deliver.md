...
description: Lär dig hur du skapar, designar och levererar personlig mobilkommunikation med Adobe Journey Optimizer. Denna omfattande guide täcker pushnotiser, meddelanden i appen, innehållskort, SMS, MMS, RCS, WhatsApp-marknadsföringsmeddelanden och kodbaserade upplevelser. Förbättra kundengagemanget, effektivisera kampanjarbetsflöden och driv resultat med realtidsstrategier för mobilmeddelanden över kanaler.
role: User
...
Upptäck hur du bygger och levererar effektfull mobilkommunikation med Adobe Journey Optimizer. Lär dig att skapa, designa och skicka olika typer av meddelanden – inklusive pushnotiser, meddelanden i appen, innehållskort, SMS/MMS/RCS, WhatsApp-marknadsföringsmeddelanden och kodbaserade upplevelser – anpassade till din målgrupp och optimerade för mobilt engagemang.
...
>1. [Skapa och aktivera målgrupper i Adobe Journey Optimizer](https://experienceleague.adobe.com/en/courses/ajo-build-and-activate-audiences)
>2. [Samordna resor och åtgärdskampanjer i Adobe Journey Optimizer](https://experienceleague.adobe.com/en/courses/ajo-design-and-manage-journeys-and-action-campaigns)
...
Förstå vilka mobilkanaler Journey Optimizer stödjer och hur du konfigurerar och skickar meddelanden med dessa kanaler.
...
2. Kontrollera att [push-kanalen](https://experienceleague.adobe.com/en/docs/journey-optimizer-learn/tutorials/configuration/channel-configuration/web-and-mobile-channels/guided-channel-setup) har konfigurerats.
...
<div class="columns">
            ...
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="https://experienceleague.adobe.com/en/docs/journey-optimizer-learn/tutorials/channels/push-channel/push-notifications-overview" title="Push-meddelanden - Översikt" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3432679/?format=jpeg&nocache=1755891402383" alt="Pushnotiser – Översikt"
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Configure and send a push campaign">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="https://experienceleague.adobe.com/en/docs/journey-optimizer-learn/tutorials/channels/push-channel/create-a-push-campaign" title="Konfigurera och skicka en pushkampanj" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3422017/?format=jpeg&nocache=1755891402391" alt="Konfigurera och skicka en pushkampanj"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/en/docs/journey-optimizer-learn/tutorials/channels/push-channel/create-a-push-campaign" target="_blank" rel="referrer" title="Konfigurera och skicka en pushkampanj">Konfigurera och skicka en push-kampanj</a>
                    </p>
...
1. Verifiera att appen är integrerad med Mobile SDK och konfigurerad för mobila kanaler.
2. Se till att kanalen i appen är konfigurerad.
3. Se till att kundprofiler och målgruppssegment är redo för målsökning.
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Author an in-app message">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/in-app-channel/author-in-app-messages.html" target="_blank" rel="referrer" title="Skriv ett meddelande i appen">Skriv ett meddelande i appen</a>
                    </p>
...
3. Se till att kundprofiler och målgrupper är redo för målsökning.
...
<div class="columns">
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Configure, author, and deliver SMS messages">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="https://experienceleague.adobe.com/en/docs/journey-optimizer-learn/tutorials/channels/sms-channel/author-sms-messages" title="Konfigurera, skriva och leverera SMS-meddelanden" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3420509?format=jpeg&nocache=1755891404139" alt="Konfigurera, skriva och leverera SMS-meddelanden"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/en/docs/journey-optimizer-learn/tutorials/channels/sms-channel/author-sms-messages" target="_blank" rel="referrer" title="Konfigurera, skriva och leverera SMS-meddelanden">Konfigurera, skriva och leverera SMS-meddelanden</a>
                    </p>
                    <p class="is-size-6">Lär dig hur du konfigurerar, skapar och levererar SMS-meddelanden i Journey Optimizer-kampanjer och resor.</p>
                </div>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Double opt-in for Sinch and Infobip">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="https://experienceleague.adobe.com/en/docs/journey-optimizer-learn/tutorials/channels/sms-channel/sms-double-opt-in" title="Dubbel anmälan för Sinch och Infobip" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3427129/?format=jpeg&nocache=1755891404148" alt="Dubbel opt-in för Sinch och Infobip"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/en/docs/journey-optimizer-learn/tutorials/channels/sms-channel/sms-double-opt-in" target="_blank" rel="referrer" title="Dubbel opt-in för Sinch och Infobip">Dubbel anmälan för Sinch och Infobip</a>
                    </p>
                    <p class="is-size-6">Lär dig hur du konfigurerar dubbelopt-in för SMS.</p>
                </div>
...
<div class="columns">
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Author an MMS message">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/en/docs/journey-optimizer-learn/tutorials/channels/sms-channel/author-mms" target="_blank" rel="referrer" title="Skriv ett MMS-meddelande">Skriv ett MMS-meddelande</a>
                    </p>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Set up RCS in Journey Optimizer">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="https://experienceleague.adobe.com/en/docs/journey-optimizer-learn/tutorials/configuration/channel-configuration/sms-mms-channel/set-up-rcs" title="Ställ in RCS i Journey Optimizer" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3464755/?format=jpeg&nocache=1755891404682" alt="Ställ in RCS i Journey Optimizer"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/en/docs/journey-optimizer-learn/tutorials/configuration/channel-configuration/sms-mms-channel/set-up-rcs" target="_blank" rel="referrer" title="Ställ in RCS i Journey Optimizer">Ställ in RCS i Journey Optimizer</a>
                    </p>
...
1. Se till att den kodbaserade kanalen har konfigurerats.
2. Se till att kundprofiler och målgrupper är redo för målsökning.
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Create a code-based experience campaign.">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/en/docs/journey-optimizer-learn/tutorials/channels/code-based-experience-channel/create-a-code-based-experience-campaign" target="_blank" rel="referrer" title="Skapa en kodbaserad upplevelsekampanj.">Skapa en kampanj baserad på kodupplevelser.</a>
                    </p>
                    <p class="is-size-6">Lär dig hur du skapar en kodbaserad upplevelsekampanj för att skala personalisering med stöd för server-, API- eller SDK-baserade implementeringsmetoder för att sömlöst integreras med utvecklingsmiljöer.</p>
                </div>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Add Form Fields to Code-Based Experience Channel Templates">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="https://experienceleague.adobe.com/en/docs/journey-optimizer-learn/tutorials/channels/code-based-experience-channel/form-fields-in-code-based-experiences" title="Lägg till formulärfält i kodbaserade upplevelsekanalmallar" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3463990/?format=jpeg&nocache=1755891405203" alt="Lägg till formulärfält i kodbaserade erfarenhetskanalmallar"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/en/docs/journey-optimizer-learn/tutorials/channels/code-based-experience-channel/form-fields-in-code-based-experiences" target="_blank" rel="referrer" title="Lägg till formulärfält i kodbaserade erfarenhetskanalmallar">Lägg till formulärfält i kodbaserade erfarenhetskanalmallar</a>
                    </p>
                    <p class="is-size-6">Upptäck hur utvecklare kan effektivisera samarbetet med marknadsföringsteam genom att aktivera redigerbara fält inom kodbaserade upplevelsekanaler.</p>
                </div>
        ...
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    ...
                    <p class="is-size-6">Videon ger en övergripande översikt över värdet av att integrera WhatsApp med Adobe Journey Optimizer. Den lyfter fram WhatsApps globala räckvidd och engagemangsfördelar samt beskriver viktiga förutsättningar som att skapa ett WhatsApp företagskonto, generera accesstokens och skapa meddelandemallar.</p>
                </div>
        ...
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    ...
                    <p class="is-size-6">Denna handledning guidar dig genom att skapa en flerstegs WhatsApp-resa med Adobe Journey Optimizer.</p>
                </div>
...
### Tidstid meddelanden till värdemoment för användaren
        ...
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    ...
                    <p class="is-size-6">Upptäck hur du identifierar och hanterar potentiella konflikter – såsom överlappande målgrupper, samtidiga tidslinjer, gemensamma kommunikationskanaler och frekvensbegränsningar mellan resor och kampanjer för att säkerställa en smidig och kundvänlig kommunikationsupplevelse.</p>
                </div>
        ...
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    ...
                    <p class="is-size-6">Lär dig hur du transformerar personaliseringsvärden med hjälp av personaliseringshjälpfunktioner och förstå olika användningsområden för hjälpfunktioner.</p>
                </div>
        ...
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    ...
                    <p class="is-size-6">Lär dig hur du använder sparade personaliserade biblioteksobjekt i ett meddelande och hur du skapar och hanterar personaliserade biblioteksobjekt.</p>
                </div>
...
<div class="columns">
        ...
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    ...
                    <p class="is-size-6">Lär dig hur du prioriterar inkommande åtgärder och säkerställer att det högst prioriterade innehållet levereras till en kund när de kvalificerar sig för flera inkommande åtgärder med samma kanalkonfiguration.</p>
                </div>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Journey Frequency Capping and Prioritization">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="https://experienceleague.adobe.com/en/docs/journey-optimizer-learn/tutorials/conflict-management/journey-frequency-capping-and-prioritization" title="Begränsning och prioritering av resfrekvens" target="_blank" rel="referrer">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/en/docs/journey-optimizer-learn/tutorials/conflict-management/journey-frequency-capping-and-prioritization" target="_blank" rel="referrer" title="Begränsning och prioritering av resfrekvens">Begränsning och prioritering av resfrekvens</a>
                    </p>
                    <p class="is-size-6">Lär dig hur du prioriterar inkommande åtgärder och säkerställer att det högst prioriterade innehållet levereras till en kund när de kvalificerar sig för flera inkommande åtgärder med samma kanalkonfiguration.</p>
                </div>
