...
| Användningsfall | Beskrivning | Exempel på användningsfall |
|---------|-------------|----------------------|
...
| **Merförsäljning och korsförsäljning** | Flyttar ut ytterligare produkter eller uppgraderingar till befintliga kunder baserat på deras beteenden, önskemål eller inköpshistorik. | Öka omprenumerationen och intäkterna |
