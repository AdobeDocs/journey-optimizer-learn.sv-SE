---
user-guide-title: Journey Optimizer självstudiekurser
user-guide-breadcrumb: Journey Optimizer Learn
user-guide-description: Det här är Journey Optimizer självstudiekurser.
...
# Journey Optimizer självstudiekurser {#tutorials}

+ [Journey Optimizer självstudiekurser](/help/_ajo-main/overview.md)
+ Introduktion till Journey Optimizer {#introduction-to-journey-optimizer}
   ...
   + [Få hjälp med AI-assistenten](/help/ai-agents/ai-assistant.md)
+ [Journey Optimizer - Mobile Learning Hub](https://experienceleague.adobe.com/sv/docs/journey-optimizer-learn/mobile-learning-hub/overview){target="_blank"}
+ Kampanjer {#create-campaigns}
   + Åtgärdskampanjer {#action-campaigns}
      + [Skapa en kampanj](/help/campaigns/action-campaigns/create-a-campaign.md)
   ...
   + Samordnade kampanjer {#orchestrated-campaigns}
      + [Introduktion till samordnade kampanjer](/help/campaigns/orchestrated-campaigns/introduction-to-orchestrated-campaigns.md)
      + [Grundläggande om relationsarkiv](/help/campaigns/orchestrated-campaigns/relational-store-basics.md)
      + [Ställ in scheman och datauppsättningar för samordnade kampanjer](/help/campaigns/orchestrated-campaigns/set-up-schemas-and-datasets-for-orchestrated-campaigns.md)
      + [Bygg en orkestrerad kampanj](/help/campaigns/orchestrated-campaigns/build-an-orchestrated-campaign.md)
+ Resor {#journeys}
   + [Journey Designer - översikt](/help/journeys/journey-designer-overview.md)
   + [Analysera och skapa resor med Journey Agent](/help/ai-agents/journey-agent-overview.md)
   + [Upptäck nya Journey Designer](/help/journeys/new-journey-designer.md)
   + [Introduktion till att skapa en resa](/help/journeys/introduction-to-building-a-journey.md)
   + [Använda datauppsättningssökning på en resa](/help/journeys/lookup-dataset.md)
   + [Skapa en testprofil](/help/journeys/test-a-journey.md)
   + [Publicera en resa](/help/journeys/publish-a-journey.md)
   + [Aktivitet för innehållsbeslut](/help/journeys/content-decision-activity.md)
   + [Mastering av flerattributsfiltrering](/help/journeys/mastering-multi-attribute-filtering.md)
   + [Validera reselogiken med körning av resan på resan](/help/journeys/journey-dry-run.md)
   + [Lås upp återinträde av resan med kompletterande ID:n](/help/journeys/unlock-journey-reentry-with-supplemental-id.md)
   + [Uppdatera innehåll i en direktresa](/help/journeys/update-content-in-live-journey.md)
   + [Kopiera en resa till en annan sandlåda](/help/journeys/copy-a-journey.md)
   + [Utlösa den dagliga resan efter gruppsegmentering](/help/journeys/trigger-daily-journey-runs-after-batch-segmentation-completion.md)
   + [Användningsexempel] {#use-cases}
      + [Användningsfall - Transaktionsresa](/help/journeys/use-case-transactional-journey.md)
      + [Användningsfall - Affärshändelse](/help/journeys/use-case-business-event.md)
      + [Användningsfall - läs målgrupper](/help/journeys/use-case-read-audience.md)
      + [Användningsfall - Målgruppskvalificering](/help/journeys/use-case-audience-qualification.md)
   + [Självstudiekurser]{#tutorials}
      + [Utlösa en resa när formulär skickas](https://experienceleague.adobe.com/sv/docs/journey-optimizer-learn/trigger-journey-on-form-submission/introduction)
+ Lojalitet {#loyalty}
   + [Skapa en lojalitetsutmaning](/help/loyalty/create-a-loyalty-challenge.md)
+ Konflikthantering och -prioritering {#conflict-management}
   + [Identifiera potentiella konflikter](/help/conflict-management/identify-potential-conflicts.md)
   + [Tilldela prioritetspoäng](/help/conflict-management/assign-priority-score.md)
   + [Frekvensbegränsning och prioritering på resan](/help/conflict-management/journey-frequency-capping-and-prioritization.md)
   + [Tysta timmar](/help/business-rules/configure-and-apply-quiet-hours.md)
...
+ Kanaler {#channels}
   ...
   + Direktpostkanal{#direct-mail-channel}
      ...
      + [Skicka direktutskick med resor](/help/channels/direct-mail-in-journeys.md)
   ...
   + Live-aktiviteter {#live-activities}
      + [iOS Live-aktiviteter](/help/channels/ios-live-activities.md)
   + Push-kanal{#push-channel}
      ...
      + [Skapa push-meddelanden på webben](/help/channels/create-web-push-notifications.md)
   ...
   + WhatApp {#whatsapp}
      + [Kom igång med whatsApp (från början till slut)](/help/channels/get-started-with-whatsapp-in-ajo.md)
      + [Introduktion till WhatsApp-kanalen](/help/channels/whatsapp-introduction.md)
      + [Konfigurera WhatsApp-kanalen](/help/channels/set-up-whatsapp.md)
      + [Skapa en whatsApp-resa](/help/channels/create-a-whatsapp-journey.md)
+ Innehållshantering{#content-management}
   ...
   + Arbeta med fragment {#fragments}
      ...
      + [Lägga till formaterad text i ett redigerbart fragment](/help/content-management/add-rich-text-to-editable-fragments.md)
   ...
   + AI Assistant för innehållsgenerering {#ai-assistant}
      + [AI Assistant för innehållsgenerering - översikt](/help/content-management/ai-assistant-for-content-generation-overview.md)
      + [Skapa innehåll med AI Assistant för innehållsgenerering](/help/content-management/create-content-using-ai-assistant-for-content-generation.md)
      + [Skapa och hantera varumärkesriktlinjer](/help/content-management/brand-guideline-creation-and-management.md)
   + [Skapa ett e-postmeddelande med GenStudio](/help/content-management/create-an-email-using-genstudio.md)
   + [Möjliggör externa dataintegreringar vid kanalutveckling](/help/content-management/external-data-integrations-in-channel-authoring.md)
...
+ Experimentation {#experimentation}
   + [Introduktion till Experimentation](/help/experimentation/introduction-to-experimentation.md)
   + [Skapa innehållsexperiment för e-postkampanjer](/help/experimentation/content-experiments-for-emails.md)
   + [Experimentation Agent - översikt](/help/ai-agents/experimentation-agent-overview.md)
+ Beslutsfunktioner{#decision-capabilities}
   + Beslut {#decisioning}
      + Grundläggande om beslutsfattande {#fundamentals}
         ...
         + [Använd rankningsformel för att leverera personaliserade erbjudanden](https://experienceleague.adobe.com/sv/docs/journey-optimizer-learn/personalizing-offers-with-ranking-formulas-based-on-user-zip-code-and-income/introduction){target="_blank"}
         + [AI-modellinsikter](/help/decisioning/ai-model-insights.md)
      + Anpassa meddelanden med hjälp av decimaler {#use-decisioning}
         + [Introduktion till beslut i e-postmeddelanden](/help/decisioning/introduction-to-decisioning-in-emails.md)
         + [Använd decimering för att personalisera e-postmeddelanden (självstudiekurs)](https://experienceleague.adobe.com/sv/docs/journey-optimizer-learn/use-decisioning-in-email-channel/introduction){target="_blank"}
         + [Använd beslut i push-meddelanden](/help/decisioning/decisioning-in-push-notifications.md)
         + [Använd beslut i ett SMS-meddelande](/help/decisioning/use-decisioning-in-an-sms-message.md)
      ...
      + Utlösa beslut från externa utlösare och interaktioner {#trigger}
         + [Utlösa resan när formulär skickas](https://experienceleague.adobe.com/sv/docs/journey-optimizer-learn/trigger-journey-on-form-submission/introduction){target="_blank"}
         + [Anpassa erbjudanden med väderdata i realtid](https://experienceleague.adobe.com/sv/docs/journey-optimizer-learn/personalizing-offers-with-real-time-weather-data/introduction){target="_blank"}
...
+ Rapportera och övervaka {#report-and-monitor}
   + [Rapportera och övervaka](/help/report-and-monitor/report-and-monitor.md)
   + [Introduktion till rapportering med Journey Optimizer](/help/report-and-monitor/introduction-to-reporting.md)
   + [Övervaka och analysera din resa med live-rapporter](/help/report-and-monitor/monitor-and-analyze-your-journey-with-live-reports.md)
   + [Övervaka och analysera din resa med reserapporter](/help/report-and-monitor/journey-reports.md)
   + [Kanalnivårapporter](/help/report-and-monitor/channel-level-reports.md)
   + [Övervaka anpassade åtgärder](/help/report-and-monitor/custom-action-monitoring-report.md)
   + [Analysera kundens övergripande resultat med alla tidsrapporter](/help/report-and-monitor/all-time-reports.md)
...
+ Konfiguration {#configuration}
   + Konfigurera kanaler {#channel-configuration}
      ...
      + E-postkanal {#email-channel}
         + [Skapa och skapa IP-pool](/help/set-up-channels/create-ip-pool.md)
         + [Konfigurera en underdomän](/help/set-up-channels/set-up-subdomain.md)
         + [Delegera CName-underdomäner](/help/set-up-channels/delegate-cname-subdomains.md)
         + [Konfigurera en e-postkanal](/help/set-up-channels/configure-email-channel.md)
      ...
      + SMS/MMS/RCS-kanal {#sms-mms-channel}
         ...
         + [Konfigurera en anpassad SMS-provider](/help/set-up-channels/configure-custom-sms-provider.md)
         ...
         + [Konfigurera RCS](/help/set-up-channels/set-up-rcs.md)
      + Webb och mobilkanaler {#web-and-mobile-channels}
         + [Inställningar för guidad kanal](/help/set-up-channels/guided-channel-setup.md)
      + WhatsApp-kanal {#whatsapp-channel}
         + [Konfigurera WhatsApp-kanalen](/help/set-up-channels/set-up-whatsapp-channel.md)
...
+ AI-assistenter och -agenter {#ai-assistant}
   ...
   + [Analysera och skapa resor med Journey Agent](https://experienceleague.adobe.com/sv/docs/journey-optimizer-learn/tutorials/journeys/journey-agent-overview?lang=en)
   + [Experimentation Agent - översikt](https://experienceleague.adobe.com/sv/docs/journey-optimizer-learn/tutorials/experimentation/experimentation-agent-overview)
...
+ Utövningar, labb och utmaningar {#exercises-and-challenges}
   ...
   + [Utmaningar](https://experienceleague.adobe.com/sv/docs/journey-optimizer-learn/challenges/introduction-and-prerequisites){target="_blank"}
   + Summit Labs {#summit-labs}
      ...
      + [Skalning av orkestrering till flerkanalsengagemang i Adobe Journey Optimizer (2025)](https://experienceleague.adobe.com/sv/docs/journey-optimizer-learn/scaling-orchestration-to-omnichannel-engagement/introduction){target="_blank"}
