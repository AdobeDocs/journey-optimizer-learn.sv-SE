...
+ Användningsfall {#use-cases}
   ...
   + [Skapa målgrupper baserat på användarinställningar](https://experienceleague.adobe.com/sv/docs/journey-optimizer-learn/tutorials/tutorial-creating-audiences/introduction)
   + [Beslut på webbsida](https://experienceleague.adobe.com/sv/docs/journey-optimizer-learn/tutorials/getting-started-with-decisioning-webpage/introduction)
...
+ Beslut på webbsida {#getting-started-with-decisioning-webpage}
   + [Introduktion](../getting-started-with-decisioning-webpage/introduction.md)
   + [Skapa taggar](../getting-started-with-decisioning-webpage/create-tags.md)
   + [Skapa erbjudande](../getting-started-with-decisioning-webpage/create-offers.md)
   + [Skapa samling](../getting-started-with-decisioning-webpage/create-collection.md)
   + [Skapa urvalsstrategi](../getting-started-with-decisioning-webpage/create-selection-strategy.md)
   + [Skapa kanal](../getting-started-with-decisioning-webpage/create-channel.md)
   + [Skapa kampanj](../getting-started-with-decisioning-webpage/create-campaign.md)
   + [Skapa beslutspolicy](../getting-started-with-decisioning-webpage/create-decision-policy.md)
   + [Skapa AEP-taggar](../getting-started-with-decisioning-webpage/create-aep-tags.md)
   + [Skapa webbsida](../getting-started-with-decisioning-webpage/create-web-page.md)
