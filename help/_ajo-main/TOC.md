...
+ Kanaler {#channels}
   ...
   + WhatApp {#whatsapp}
      ...
      + [Konfigurera WhatsApp-kanalen](https://experienceleague.adobe.com/en/docs/journey-optimizer-learn/tutorials/configuration/channel-configuration/whatsapp-channel/set-up-whatsapp-channel)
