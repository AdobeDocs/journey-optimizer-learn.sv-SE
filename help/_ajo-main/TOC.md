...
+ [Journey Optimizer - Mobile Learning Hub](https://experienceleague.adobe.com/sv/docs/journey-optimizer-learn/mobile-learning-hub/overview)
...
+ Användningsexempel och metodtips{#use-cases}
   ...
   + [Skalning av orkestrering till flerkanalsengagemang](https://experienceleague.adobe.com/en/docs/journey-optimizer-learn/tutorials/exercises-and-challenges/summit-labs/introduction){target="_blank"}
...
+ Utövningar, labb och utmaningar {#exercises-and-challenges}
   ...
   + Summit Labs {#summit-labs}
      + [Skapa personliga mobilstunder med Adobe Journey Optimizer (2024)](/help/summit-lab-2024/l820-lab-workbook/lab-overview.md){target="_blank"}
      + [Skalning av orkestrering till flerkanalsengagemang i Adobe Journey Optimizer (2025)](/help/summit-lab-2025/introduction.md){target="_blank"}
