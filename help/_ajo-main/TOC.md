...
+ Beslutsfunktioner{#decision-capabilities}
   + Beslut {#decisioning}
      ...
      + [Aktivitet för innehållsbeslut på resor](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/journeys/content-decision-activity.html)
