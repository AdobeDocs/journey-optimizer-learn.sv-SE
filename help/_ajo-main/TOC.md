...
+ Beslutsfunktioner{#decision-capabilities}
   + Beslut {#decisioning}
      ...
      + [Använd beslut i e-postkanal](https://experienceleague.adobe.com/en/docs/journey-optimizer-learn/use-decisioning-in-email-channel/introduction)
...
+ Användningsexempel och metodtips{#use-cases}
   ...
   + Använd fallspelningsböcker {#use-case-playbooks}
      + [Ökning](https://experienceleague.adobe.com/en/docs/platform-learn/tutorials/use-case-playbooks/overview){target="_blank"}
