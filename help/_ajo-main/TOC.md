...
+ Resor {#create-journeys}
   ...
   + [Felsöka inkommande åtgärder under resor](https://experienceleague.adobe.com/en/docs/journey-optimizer/using/orchestrate-journeys/manage-journey/troubleshooting-inbound){target="_blank"}
...
+ Konfiguration {#configuration}
   + Konfigurera kanaler {#channel-configuration}
      ...
      + SMS-/MMS-kanal {#sms-mms-channel}
         ...
         + [Konfigurera RCS för företag](/help/set-up-channels/set-up-rcs.md)
